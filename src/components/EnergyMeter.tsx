  ...
  return (
    <div className="flex w-full items-center gap-3">
      ...
      <div className="relative h-[6px] flex-1">
        {/* Bar track (clipped for fill) */}
        <div className="absolute inset-0 overflow-hidden rounded-full bg-white/[0.05] ring-1 ring-inset ring-white/[0.04]">
          <motion.div
        ...
        {/* Drop threshold tick + label at 88% */}
        <div
          className="pointer-events-none absolute w-px bg-white/25"
          style={{ left: '88%', top: -3, bottom: -3 }}
        />
        <span
          className="label-caps pointer-events-none absolute text-[8px] text-white/38"
          style={{ left: '88%', top: 10, transform: 'translateX(-50%)' }}
        >
          drop
        </span>
      </div>
